(function () {
  ...
  const STYLE = `
    ...
    *{box-sizing:border-box}
    a{color:#123a72}
    .rp-wrap{max-width:1400px;margin:0 auto;padding:0 0 22px;color:#122033;}
